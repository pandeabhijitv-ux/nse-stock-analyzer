...
module.exports = async (req, res) => {
  try {
    ...
    if (refresh === 'true') {
      ...
      console.log('⚠️ Manual refresh via this endpoint not supported - use /api/trigger instead');
      
      // Just delete cache and return whatever is available
      // Fresh data will be generated by cron or trigger endpoint
